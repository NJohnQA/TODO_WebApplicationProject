...
public class SpringBeanUtil {
	// Merge not null is used to ensure that we don’t get an error when we do an update statement.
	// you need to create a custom error handler that you can use.
